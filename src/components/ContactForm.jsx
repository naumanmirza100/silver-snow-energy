    ...
    if (validate()) {
      ...
      try {
        ...
        const result = await emailjs.send(
          'service_teyy3gd', // Service ID
          'template_g9xgodd', // You'll need to replace this with your actual template ID
          templateParams,
          'zzzSdNfPnYmtzpEcX'         // Replace with your EmailJS public key
        );
